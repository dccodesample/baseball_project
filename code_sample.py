# This code sample is a file from the project described in my resume. The sample is a python class that scrapes the website
# www.baseball-reference.com, for box score data for a given list of teams and seasons. For more information about this project please refer
# to my resume, or the project itself which is located at my github page, https://github.com/dccodesample/baseball_project.
