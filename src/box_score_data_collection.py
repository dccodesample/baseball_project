...
# generates home page urls for each team for each year
...
# gets all the box score urls for each team for all given years
...
# gets all box score data for each team for all given years
...
# writes the box score data to a datafile
logger.info('STARTING: Outputting collected box score data')
web_scraper.output_box_score_data(box_scores, 'data/box_score_data.json')
logger.info('FINISHED: Outputting collected box score data')
