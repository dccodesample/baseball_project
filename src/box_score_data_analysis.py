...
with open('data/box_score_data_medium.json', 'r') as f:
...
plt.yticks(y_ticks, fontsize=8)
# cleaned_x_ticks = [team_abbrv.replace('_', ' ') for team_abbrv in worst_blown_lead_seasons_data['blown_leads'].index.values]
# plt.xticks(cleaned_x_ticks, fontsize=8)
